...
+ L'ensemble des nombres pairs, $\\{2n, n \in \mathbb{N} \\}$, est dénombrable. Si on pose $f(n) = 2n \hspace{2mm} \forall \hspace{2mm} n \in \mathbb{N} $ on remarque que cette fonction est une bijection de $\hspace{2mm} \mathbb{N} $ dans $\\{2n, n \in \mathbb{N} \\}$  
